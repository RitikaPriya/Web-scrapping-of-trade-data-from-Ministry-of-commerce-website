...
def exportrs(year):
    ...
    driver.get("https://tradestat.commerce.gov.in/eidb/icomcntq.asp")
...
combined_dataframe.to_csv('india_imports_yearly.csv',index=False)
...
# Use reduce to iteratively merge all DataFrames in the list
combined_dataframe = reduce(merge_dataframes, rsdata)
combined_dataframe.to_csv('india_imports_yearly_qty.csv',index=False)
