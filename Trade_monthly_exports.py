...
def exportrs(year, month, driver):
    ...
    driver.get("https://tradestat.commerce.gov.in/meidb/comcntq.asp?ie=e")
...
combined_dataframe.to_csv('india_exports_monthly.csv',index=False)
...
# Use reduce to iteratively merge all DataFrames in the list
combined_dataframe = reduce(merge_dataframes, rsdata)
combined_dataframe.to_csv('india_exports_monthly_qty.csv',index=False)
